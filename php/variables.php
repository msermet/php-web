        ...
        <div class="col-7 bg-dark p-3 shadow">
            <div class="d-flex">
                ...
                <div class="bg-black rounded-4 p-3 flex-fill">
                    ...
                    <p>Il y a <?= strlen($nom) ?> caractères dans le nom <?= $nom ?></p>
                    <p>Il y a
                        <span class="fw-bold text-success"><?= strlen($nom) ?></span>
                        caractères dans le nom <span class="fst-italic text-uppercase"><?= $nom ?></span></p>
                </div>
            </div>
        </div>
    </div>
